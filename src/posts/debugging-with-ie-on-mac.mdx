---
title: Mac OS 환경에서 IE 디버깅하기
description: VirutalBox를 이용한 Interent Explorer 디버깅
createdAt: 2020-01-29 00:00:00
updatedAt: 2020-01-29 00:00:00
tags: [디버깅]
cover: './covers/debugging-with-ie-on-mac.png'
---

VirtualBox를 이용하여 Mac OS 환경에서도 IE를 디버깅할 수 있다.

## 1단계: VirtualBox 설치 {#install-virtualbox}
...
## 2단계: Virtual Machine 설치 {#install-virtual-machine}
